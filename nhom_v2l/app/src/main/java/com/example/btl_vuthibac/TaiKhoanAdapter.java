...
public class TaiKhoanAdapter extends BaseAdapter {
    ...
    public TaiKhoanAdapter(Context context, int layout, List<TaiKhoan> taiKhoanList) {
        ...
        this.database = new Database(context, "datlichkham.db", null, 1); // Khởi tạo đối tượng Database
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        sua.setOnClickListener(v -> {
            ...
            RadioButton bacsi = dialogView.findViewById(R.id.bacsi);
            ...
            builder.setView(dialogView)
                    .setPositiveButton("Lưu", (dialog, which) -> {
                        ...
                        String quyen = user.isChecked() ? "user" :
                                bacsi.isChecked() ? "bacsi" : "admin";
